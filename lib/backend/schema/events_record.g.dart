    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'mainImage':
          ...
          break;
        case 'ongoing':
          result.ongoing = serializers.deserialize(value,
...
class _$EventsRecord extends EventsRecord {
  ...
  final String banner;
  @override
  final BuiltList<String> mainImage;
  @override
  final bool ongoing;
  @override
  ...
  _$EventsRecord._(
      {this.name, this.banner, this.mainImage, this.ongoing, this.reference})
      : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc($jc($jc(0, name.hashCode), banner.hashCode),
                mainImage.hashCode),
            ongoing.hashCode),
        reference.hashCode));
  }
...
class EventsRecordBuilder
  ...
  ListBuilder<String> _mainImage;
  ListBuilder<String> get mainImage =>
      _$this._mainImage ??= new ListBuilder<String>();
  set mainImage(ListBuilder<String> mainImage) => _$this._mainImage = mainImage;

  bool _ongoing;
  bool get ongoing => _$this._ongoing;
  set ongoing(bool ongoing) => _$this._ongoing = ongoing;
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'EventsRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
